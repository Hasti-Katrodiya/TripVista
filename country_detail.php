...
<div class="my-2">
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            <h1 class="text-center my-3 detail_h1 container-fluid my-4 py-4">Top Tourist Places to Visit in <span
                    class="color-change">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-4 container mb-4">
                        <div class=" card custom-card h-100 places_card">
                            <img src="<?php echo $row['place_img']; ?>" alt="<?php echo $row['place_name']; ?>"
